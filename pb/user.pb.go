...
type User struct {
	...
	Useranem          string                 `protobuf:"bytes,1,opt,name=useranem,proto3" json:"useranem,omitempty"` // 1 field number
...
func (x *User) GetUseranem() string {
	if x != nil {
		return x.Useranem
	}
	return ""
...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x61, 0x6e, 0x65, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73,
	0x65, 0x72, 0x61, 0x6e, 0x65, 0x6d, 0x12, 0x1b, 0x0a, 0x09, 0x66, 0x75, 0x6c, 0x6c, 0x5f, 0x6e,
